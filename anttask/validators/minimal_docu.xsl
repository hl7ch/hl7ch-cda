...
<xhtml:ul xmlns="http://purl.oclc.org/dsdl/schematron" id="minimal_docu">
	  ...
	  <!--RULE -->
<xsl:template match="cda:ClinicalDocument" priority="1001" mode="M3">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Für Dokumente, welche anhand der vorliegenden Spezifikation erstellt wurden soll folgende template ID verwendet werden: templateId extension="CDA-CH" root="2.16.756.5.30.1.1.1.1"</xhtml:p>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="fr_ch">Le modèle d'identifiant suivant doit être utilisé pour les documents produits au moyen de la présente spécification: templateId extension="CDA-CH" root="2.16.756.5.30.1.1.1.1"</xhtml:p>
			            </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="self::cda:ClinicalDocument">
               ...
               <svrl:text>
			               ...
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="fr_ch">L'élément ClinicalDocument doit provenir du namespace urn :hl-org-v3.</xhtml:p>
			            </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
