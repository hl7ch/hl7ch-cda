...
<xsl:template match="/">
   ...
   <!--SCHEMATRON PATTERNS-->
<xhtml:h1 xmlns="http://purl.oclc.org/dsdl/schematron" class="title" lang="de_ch">Schematronregeln for ERezept Swiss Medical Suite 1.0</xhtml:h1>
   ...
   <xhtml:ul xmlns="http://purl.oclc.org/dsdl/schematron" id="reference">
		    <xhtml:li>ERezept-1.0.ent</xhtml:li>
		    <xhtml:li>vhitg-ruleset-150.ent</xhtml:li>
		    <xhtml:li>cda-ch-1.2.ent</xhtml:li>
	  </xhtml:ul>

   <!--PATTERN -->
<xhtml:ul xmlns="http://purl.oclc.org/dsdl/schematron" id="ERezept-1.0">
		    <xhtml:li class="filename">ERezept-1.0.ent</xhtml:li>
		    <xhtml:li class="version">1.0</xhtml:li>
	  </xhtml:ul>

	  <!--RULE -->
<xsl:template match="cda:ClinicalDocument" priority="1003" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:ClinicalDocument"/>
      <xhtml:h3 xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">CDA-CH Metadaten für das SwissMedicalSuite ERezept</xhtml:h3>
      <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Die nachfolgenden Regeln beschreiben die Prüfungen zu den Metadaten für das SwissMedicalSuite ERezept</xhtml:p>

		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='2.16.756.5.30.1.105' and @extension='SwissMedicalSuite_ERezept' ]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:templateId[@root='2.16.756.5.30.1.105' and @extension='SwissMedicalSuite_ERezept' ]">
               <xsl:attribute name="id">entity_ERezept-1.0-0001</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Falsche oder fehlende Template Spezifikation: templateID muss mit extension SwissMedicalSuite_ERezept und mit root 2.16.756.5.30.1.105 angeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:id[@root='2.16.756.5.30.1.105.1.6' and string-length(@extension)&gt;16 and translate(substring(@extension,2,string-length(@extension)-1),'0123456789','')='' and translate(substring(@extension,1,1),'ABCDEFGHIJKLMNOPQRSTUVWXYZ','')='']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:id[@root='2.16.756.5.30.1.105.1.6' and string-length(@extension)&gt;16 and translate(substring(@extension,2,string-length(@extension)-1),'0123456789','')='' and translate(substring(@extension,1,1),'ABCDEFGHIJKLMNOPQRSTUVWXYZ','')='']">
               <xsl:attribute name="id">entity_ERezept-1.0-0002</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
 	                <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Die Globale Rezept-Id muss als Kombination ZSR (Buchstabe+6Zahlen) plus timestamp in ms angegeben, root mit 2.16.756.5.30.1.105.1.6</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:effectiveTime[string-length(@value)=14 and @value&gt;20100801000000]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:effectiveTime[string-length(@value)=14 and @value&gt;20100801000000]">
               <xsl:attribute name="id">entity_ERezept-1.0-0003</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
 	                <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Das Austellungsdatum des Rezeptes des Rezeptes muss im Format JJJJMMTTHHMMSS angegeben sein </xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:family and string-length(normalize-space(cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:family))&gt;0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:family and string-length(normalize-space(cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:family))&gt;0">
               <xsl:attribute name="id">entity_ERezept-1.0-0004</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
                  <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Nachname des Rezeptempfängers muss angegeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:given and string-length(normalize-space(cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:given))&gt;0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:given and string-length(normalize-space(cda:recordTarget/cda:patientRole/cda:patient/cda:name/cda:given))&gt;0">
               <xsl:attribute name="id">entity_ERezept-1.0-0005</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
                  <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Vorname des Rezeptempfängers muss angegeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:author/cda:assignedAuthor/cda:id[@root='1.3.88' and string-length(@extension)=13]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:author/cda:assignedAuthor/cda:id[@root='1.3.88' and string-length(@extension)=13]">
               <xsl:attribute name="id">entity_ERezept-1.0-0006</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Der Autor des Rezeptes muss mit dem EAN Code identifiziert werden</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:family and string-length(normalize-space(cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:family))&gt;0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:family and string-length(normalize-space(cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:family))&gt;0">
               <xsl:attribute name="id">entity_ERezept-1.0-0007</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
                  <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Nachname des Autor des Rezeptes muss angegeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:given and string-length(normalize-space(cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:given))&gt;0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:given and string-length(normalize-space(cda:author/cda:assignedAuthor/cda:assignedPerson/cda:name/cda:given))&gt;0">
               <xsl:attribute name="id">entity_ERezept-1.0-0008</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
                  <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Vorname des Autor des Rezeptes muss angegeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:id[@root='2.16.756.5.30.1.105.1.1.2' and string-length(@extension)=7]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:id[@root='2.16.756.5.30.1.105.1.1.2' and string-length(@extension)=7]">
               <xsl:attribute name="id">entity_ERezept-1.0-0009</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">ZSR-Nummer des Austeller des Rezeptes muss angegeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:streetAddressLine and string-length(normalize-space(cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:streetAddressLine))&gt;0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:streetAddressLine and string-length(normalize-space(cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:streetAddressLine))&gt;0">
               <xsl:attribute name="id">entity_ERezept-1.0-0010</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
                  <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Adresse des Austeller des Rezeptes: Strasse fehlt</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:postalCode and string-length(normalize-space(cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:postalCode))&gt;0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:postalCode and string-length(normalize-space(cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:postalCode))&gt;0">
               <xsl:attribute name="id">entity_ERezept-1.0-0011</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
                  <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Adresse des Austeller des Rezeptes: PLZ fehlt</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:city and string-length(normalize-space(cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:city))&gt;0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:city and string-length(normalize-space(cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:addr/cda:city))&gt;0">
               <xsl:attribute name="id">entity_ERezept-1.0-0012</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
                  <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Adresse des Austeller des Rezeptes: Ort fehlt</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:component/cda:structuredBody/cda:component/cda:section/cda:code[@nullFlavor='NA']/cda:translation[@codeSystem='2.16.756.5.30.1.105.2.2' and @code='VERORDNETEMEDIKAMENTE']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:component/cda:structuredBody/cda:component/cda:section/cda:code[@nullFlavor='NA']/cda:translation[@codeSystem='2.16.756.5.30.1.105.2.2' and @code='VERORDNETEMEDIKAMENTE']">
               <xsl:attribute name="id">entity_ERezept-1.0-0013</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Section Verordnete Medikation muss angegeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:code[@nullFlavor='NA']/cda:translation[@codeSystem='2.16.756.5.30.1.105.2.2' and @code='VERORDNETEMEDIKAMENTE']]"
                 priority="1002"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:code[@nullFlavor='NA']/cda:translation[@codeSystem='2.16.756.5.30.1.105.2.2' and @code='VERORDNETEMEDIKAMENTE']]"/>
      <xhtml:h3 xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Verordnete Medikations-Sektion - Freitextangaben</xhtml:h3>
      <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Die nachfolgenden Regeln beschreiben die Prüfungen zu der Verordneten Medikations-Sektion.</xhtml:p>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="self::cda:section">
               <xsl:attribute name="id">entity_ERezept-1.0-1000</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Verordnete Medikamente müssen müssen als 'section' im CDA Body deklariert werden.</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="cda:text">
               <xsl:attribute name="id">entity_ERezept-1.0-1001</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Verordnete Medikamente müssen einen narrativen Text enthalten.</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="cda:title">
               <xsl:attribute name="id">entity_ERezept-1.0-1002</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Verordnete Medikamente müssen einen narrativen Titel enthalten.</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='RQO']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:entry/cda:substanceAdministration[@classCode='SBADM' and @moodCode='RQO']">
               <xsl:attribute name="id">entity_ERezept-1.0-1003</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Verordnete Medikamente müssen als 'substanceAdministration' mit Classcode SBADM und moodCode RQO deklariert werden.</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="cda:substanceAdministration[@classCode='SBADM' and @moodCode='RQO']"
                 priority="1001"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cda:substanceAdministration[@classCode='SBADM' and @moodCode='RQO']"/>
      <xhtml:h3 xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Verordnete Medikations-Sektion - Strukturierte Angaben</xhtml:h3>
      <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Die nachfolgenden Regeln beschreiben die Prüfungen zu substanceAdministrations Klasse</xhtml:p>

		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:id/@root='2.16.756.5.30.2.6.1' or ../local-name()='entryRelationship'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:id/@root='2.16.756.5.30.2.6.1' or ../local-name()='entryRelationship'">
               <xsl:attribute name="id">entity_ERezept-1.0-2000</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Verordnete Medikamente müssen mit der Identifikation aus SwissIndex identifiziert werden (Pharmacode).</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:text/cda:reference/@value or ../local-name()='entryRelationship'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:text/cda:reference/@value or ../local-name()='entryRelationship'">
               <xsl:attribute name="id">entity_ERezept-1.0-2001</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Eine Referenz auf das verodnete Medikatement in der Sektion muss angeben sein.</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="count(cda:effectiveTime[@xsi:type='IVL_TS'])=0 or cda:effectiveTime[@xsi:type='IVL_TS']/cda:high/@value or ../local-name()='entryRelationship'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="count(cda:effectiveTime[@xsi:type='IVL_TS'])=0 or cda:effectiveTime[@xsi:type='IVL_TS']/cda:high/@value or ../local-name()='entryRelationship'">
               <xsl:attribute name="id">entity_ERezept-1.0-2002</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Gültigkeit muss strukturiert mit Enddatum angegben falls sie nicht implizit definiert ist</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="count(cda:effectiveTime[@xsi:type='PIVL_TS' and @operator='A'])&gt;0 or cda:entryRelationship[@typeCode='COMP']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="count(cda:effectiveTime[@xsi:type='PIVL_TS' and @operator='A'])&gt;0 or cda:entryRelationship[@typeCode='COMP']">
               <xsl:attribute name="id">entity_ERezept-1.0-2003</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:doseQuantity or cda:entryRelationship[@typeCode='COMP']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:doseQuantity or cda:entryRelationship[@typeCode='COMP']">
               <xsl:attribute name="id">entity_ERezept-1.0-2004</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <xsl:attribute name="id">entity_ERezept-1.0-2005</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:consumable/cda:manufacturedProduct/cda:manufacturedMaterial/cda:code[@codeSystem='2.16.840.1.113883.6.73'] or ../local-name()='entryRelationship'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:consumable/cda:manufacturedProduct/cda:manufacturedMaterial/cda:code[@codeSystem='2.16.840.1.113883.6.73'] or ../local-name()='entryRelationship'">
               <xsl:attribute name="id">entity_ERezept-1.0-2006</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Medikationsdaten müssen mit dem WHO ATC Code klassifiziert werden.</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="cda:entryRelationship[@typeCode='REFR' and @inversionInd='false']/cda:supply[@classCode='SPLY' and @moodCode='INT']/cda:quantity[@value&gt;0] or ../local-name()='entryRelationship'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cda:entryRelationship[@typeCode='REFR' and @inversionInd='false']/cda:supply[@classCode='SPLY' and @moodCode='INT']/cda:quantity[@value&gt;0] or ../local-name()='entryRelationship'">
               <xsl:attribute name="id">entity_ERezept-1.0-2007</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Die Anzahl Packungen müssen angeben sein</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="cda:substanceAdministration[@classCode='SBADM' and @moodCode='RQO']/cda:effectiveTime[@xsi:type='PIVL_TS' and @operator='A']/cda:phase"
                 priority="1000"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cda:substanceAdministration[@classCode='SBADM' and @moodCode='RQO']/cda:effectiveTime[@xsi:type='PIVL_TS' and @operator='A']/cda:phase"/>

		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value='190001010800' or @value='190001011200' or @value='190001011600' or @value='190001012000'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@value='190001010800' or @value='190001011200' or @value='190001011600' or @value='190001012000'">
               <xsl:attribute name="id">entity_ERezept-1.0-2100</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
			               <xhtml:p xmlns="http://purl.oclc.org/dsdl/schematron" lang="de_ch">Der Einnahmeplan muss gemäss SwissMedicalERezept mit morgens (190001010800), mittags (190001011200), nachmittags (190001011600) oder abends (190001012000) codiert werden</xhtml:p>
		             </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE general-addr-->
<xsl:template match="cda:addr[@nullFlavor]" priority="1005" mode="M8">
...
<xsl:choose>
	  ...
	  <!--RULE general-addr-1-->
<xsl:template match="cda:addr[normalize-space(.) = '']" priority="1004" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE general-id-->
<xsl:template match="cda:id" priority="1000" mode="M8">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:patient" priority="1002" mode="M10">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="cda:assignedPerson" priority="1001" mode="M10">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:assignedPerson" priority="1001" mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:assignedPerson"/>
      <xsl:apply-templates select="@*|*" mode="M11"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:telecom" priority="1000" mode="M13">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:ClinicalDocument" priority="1000" mode="M14">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:ClinicalDocument"/>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:ClinicalDocument/cda:typeId" priority="1000" mode="M15">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:id" priority="1000" mode="M16">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:ClinicalDocument/cda:code" priority="1000" mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:ClinicalDocument/cda:effectiveTime" priority="1000" mode="M18">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:template match="/cda:ClinicalDocument" priority="1001" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/cda:ClinicalDocument"
                       id="cda-languageCode"/>
...
<xsl:template match="/cda:ClinicalDocument/cda:languageCode" priority="1000" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:recordTarget" priority="1000" mode="M20">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:participant" priority="1000" mode="M22">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:ClinicalDocument" priority="1000" mode="M23">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:ClinicalDocument"/>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:structuredBody" priority="1000" mode="M24">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:structeredbody/cda:component/cda:section" priority="1000" mode="M25">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:section/cda:code" priority="1000" mode="M26">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:observationMedia" priority="1000" mode="M27">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cda:entry/cda:observation/cda:value" priority="1000" mode="M28">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
