...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA SETUP-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="tutorial minimal schematron"
                              schemaVersion="">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">tutorial minimal schematron</svrl:text>

   <!--PATTERN -->


	<!--RULE -->
<xsl:template match="cda:ClinicalDocument" priority="1001" mode="M2">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="self::cda:ClinicalDocument">
               ...
               <svrl:text>ClinicalDocument element muss aus dem urn:hl7-org-v3 namespace sein.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*|comment()|processing-instruction()" mode="M2"/>
