...
<rule xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <report role="warning"
           test="not(not(@use) or translate(concat(' ', @use, ' '), '(H|HP|HV|WP|AS|EC|MC|PG) ', '') = '')"
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_TEL.AT">dtr1-2-TEL.AT: @use MUSS aus den Werten 'H', 'HP', 'HV', 'WP', 'AS', 'EC', 'MC', 'PG' gewählt werden.</report>
    <report role="warning"
