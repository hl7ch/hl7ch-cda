...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    <title>Scenario: RecommendationRequest - CDA-CH-VACD - Immunization Recommendation Request (2.16.756.5.30.1.127.77.1.4.5)</title>
...
<!-- CDA-CH-VACD-REQ-V2 -->
    <include href="include/2.16.756.5.30.1.1.10.1.17-2018-03-26T212045.sch"/>
    <include href="include/2.16.756.5.30.1.1.10.1.17-2018-03-26T212045-closed.sch"/>
