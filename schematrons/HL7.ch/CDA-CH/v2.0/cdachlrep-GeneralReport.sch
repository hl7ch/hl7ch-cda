...
<!-- CDA-CH-LREP-GR-V1 -->
    <pattern>
        ...
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.10.12.2'] and hl7:templateId[@root = '2.16.840.1.113883.10.12.1'] and hl7:templateId[@root = '2.16.756.5.30.1.127.1.4'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.1.10']]" see="http://art-decor.org/art-decor/decor-templates--cdachlrep-?id=2.16.756.5.30.1.1.10.1.10">Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.10.12.2'] and hl7:templateId[@root = '2.16.840.1.113883.10.12.1'] and hl7:templateId[@root = '2.16.756.5.30.1.127.1.4'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.1.10']]</assert>
        </rule>
    </pattern>
   ...
   <!-- Create phases for more targeted validation on large instances -->
    <phase id="AllExceptClosed">
        ...
        <active pattern="template-2.16.756.5.30.1.1.10.4.4-2018-07-14T122638"/>
...
<!-- cdach_header_DocumentReplacement -->
   ...
   <!-- chpalm_entry_LaboratoryReportDataProcessingEntry -->
    <include href="include/2.16.756.5.30.1.1.10.4.4-2018-07-14T122638.sch"/>
