...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    <title>Scenario: Administration - CDA-CH-VACD - Immunization Administration (2.16.756.5.30.1.127.77.1.4.3)</title>
...
<!-- CDA-CH-VACD-ADM-V2 -->
    <include href="include/2.16.756.5.30.1.1.10.1.16-2018-03-26T211432.sch"/>
    <include href="include/2.16.756.5.30.1.1.10.1.16-2018-03-26T211432-closed.sch"/>
