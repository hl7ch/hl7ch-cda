...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title> Schematron file for  - Medication Treatment Plan document </title>
   ...
   <!-- Include the project schematrons related to scenario MTP -->

   <!-- MedicationTreatmentPlanDocument -->
   <pattern>
      <title>MedicationTreatmentPlanDocument</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root='2.16.840.1.113883.10.12.2'] and hl7:templateId[@root='2.16.840.1.113883.10.12.1'] and hl7:templateId[@root='2.16.756.5.30.1.127.1.4'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.9.1.1.6'] and hl7:templateId[@root='2.16.756.5.30.1.1.10.1.7']]"
                 see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.1.7-2017-04-12T135731.html">Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root='2.16.840.1.113883.10.12.2'] and hl7:templateId[@root='2.16.840.1.113883.10.12.1'] and hl7:templateId[@root='2.16.756.5.30.1.127.1.4'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.9.1.1.6'] and hl7:templateId[@root='2.16.756.5.30.1.1.10.1.7']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.756.5.30.1.1.10.1.7-2017-04-12T135731.sch"/>
   <include href="include/2.16.756.5.30.1.1.10.1.7-2017-04-12T135731-closed.sch"/>


   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.7-2017-04-12T135731"/>
   ...
   <phase id="MedicationTreatmentPlanDocument">
      <active pattern="template-2.16.756.5.30.1.1.10.1.7-2017-04-12T135731"/>
   </phase>
   <phase id="MedicationTreatmentPlanDocument-closed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.7-2017-04-12T135731-closed"/>
   </phase>
