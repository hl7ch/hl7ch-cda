...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title> Schematron file for  - Medication Card document </title>
   ...
   <!-- Include the project schematrons related to scenario PMLC -->

   <!-- MedicationCardDocument -->
   <pattern>
      <title>MedicationCardDocument</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root='2.16.840.1.113883.10.12.2'] and hl7:templateId[@root='2.16.840.1.113883.10.12.1'] and hl7:templateId[@root='2.16.756.5.30.1.127.1.4'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.9.1.1.5'] and hl7:templateId[@root='2.16.756.5.30.1.1.10.1.3']]"
                 see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.1.3-2016-05-13T000000.html">Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root='2.16.840.1.113883.10.12.2'] and hl7:templateId[@root='2.16.840.1.113883.10.12.1'] and hl7:templateId[@root='2.16.756.5.30.1.127.1.4'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.9.1.1.5'] and hl7:templateId[@root='2.16.756.5.30.1.1.10.1.3']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.756.5.30.1.1.10.1.3-2016-05-13T000000.sch"/>
   <include href="include/2.16.756.5.30.1.1.10.1.3-2016-05-13T000000-closed.sch"/>


   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.3-2016-05-13T000000"/>
   ...
   <phase id="MedicationCardDocument">
      <active pattern="template-2.16.756.5.30.1.1.10.1.3-2016-05-13T000000"/>
   </phase>
   <phase id="MedicationCardDocument-closed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.3-2016-05-13T000000-closed"/>
   </phase>
