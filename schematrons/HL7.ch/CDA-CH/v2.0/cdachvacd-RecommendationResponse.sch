...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title> Schematron file for ClinicalDocument - CDA-CH-VACD - Immunization Recommendation Response </title>
   ...
   <!-- Include the project schematrons related to scenario RecommendationResponse -->

   <!-- CDA-CH-VACD-RSP-V2 -->
   <pattern>
      <title>CDA-CH-VACD-RSP-V2</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root='2.16.840.1.113883.10.12.2'] and hl7:templateId[@root='2.16.840.1.113883.10.12.1'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.18.1.2'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root='2.16.756.5.30.1.1.10.1.18']]"
                 see="http://ehealthsuisse.art-decor.org/cdachvacd-html-20180507T170353/tmp-2.16.756.5.30.1.1.10.1.18-2018-04-19T000000.html">Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root='2.16.840.1.113883.10.12.2'] and hl7:templateId[@root='2.16.840.1.113883.10.12.1'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.18.1.2'] and hl7:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root='2.16.756.5.30.1.1.10.1.18']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.756.5.30.1.1.10.1.18-2018-04-19T000000.sch"/>
   <include href="include/2.16.756.5.30.1.1.10.1.18-2018-04-19T000000-closed.sch"/>


   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.18-2018-04-19T000000"/>
      ...
      <active pattern="template-2.16.756.5.30.1.1.10.2.69-2018-04-19T000000"/>
      ...
      <active pattern="template-2.16.756.5.30.1.1.10.3.25-2016-11-11T000000"/>
      ...
      <active pattern="template-2.16.756.5.30.1.1.10.3.47-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.3.48-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.3.5-2017-06-21T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.3.50-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.3.51-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.3.53-2018-04-19T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.100-2016-11-11T000000"/>
      ...
      <active pattern="template-2.16.756.5.30.1.1.10.4.89-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.90-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.91-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.92-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.93-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.94-2016-11-11T000000"/>
      ...
      <active pattern="template-2.16.756.5.30.1.1.10.4.97-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.98-2016-11-11T000000"/>
      <active pattern="template-2.16.756.5.30.1.1.10.4.99-2016-11-11T000000"/>
   ...
   <phase id="CDA-CH-VACD-RSP-V2">
      <active pattern="template-2.16.756.5.30.1.1.10.1.18-2018-04-19T000000"/>
   </phase>
   <phase id="CDA-CH-VACD-RSP-V2-closed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.18-2018-04-19T000000-closed"/>
   </phase>
   ...
   <!-- cdachvacd_header_PatientMasked -->
   <include href="include/2.16.756.5.30.1.1.10.2.69-2018-04-19T000000.sch"/>
   ...
   <include href="include/2.16.756.5.30.1.1.10.3.25-2016-11-11T000000.sch"/>
   ...
   <!-- chpcc_section_ImmunizationRecommendationsCoded -->
   <include href="include/2.16.756.5.30.1.1.10.3.48-2016-11-11T000000.sch"/>
   ...
   <include href="include/2.16.756.5.30.1.1.10.3.50-2016-11-11T000000.sch"/>
   <!-- chpcc_section_AllergiesOtherAdverseReactionsCoded -->
   <include href="include/2.16.756.5.30.1.1.10.3.51-2016-11-11T000000.sch"/>
   ...
   <include href="include/2.16.756.5.30.1.1.10.4.100-2016-11-11T000000.sch"/>
   ...
   <include href="include/2.16.756.5.30.1.1.10.4.90-2016-11-11T000000.sch"/>
   <!-- chpcc_entry_AllergiesAndIntolerancesConcern -->
   <include href="include/2.16.756.5.30.1.1.10.4.91-2016-11-11T000000.sch"/>
   <!-- chpcc_entry_PregnancyObservation -->
   <include href="include/2.16.756.5.30.1.1.10.4.92-2016-11-11T000000.sch"/>
   <!-- chpcc_entry_ImmunizationRecommendation -->
   <include href="include/2.16.756.5.30.1.1.10.4.93-2016-11-11T000000.sch"/>
   ...
   <!-- chpcc_entry_Problem -->
   <include href="include/2.16.756.5.30.1.1.10.4.97-2016-11-11T000000.sch"/>
   <!-- chpcc_entry_AllergyOrIntolerance -->
   <include href="include/2.16.756.5.30.1.1.10.4.98-2016-11-11T000000.sch"/>
   <!-- chpcc_entry_Severity -->
   <include href="include/2.16.756.5.30.1.1.10.4.99-2016-11-11T000000.sch"/>
   <!-- cdach_other_Author -->
