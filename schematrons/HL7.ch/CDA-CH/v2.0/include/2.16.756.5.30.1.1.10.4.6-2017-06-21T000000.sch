...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-2.16.756.5.30.1.1.10.4.6-2017-06-21T000000">
...
-->
    <rule context="//hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.3.1']" id="d130e4776-false-d184275e0">
        <extends rule="II"/>
...
Item: (chpalm_entry_HumanPatientWithNonHumanSubject)
-->
    <rule context="//hl7:relatedSubject" id="d130e4778-false-d184292e0">
...
Item: (chpalm_entry_HumanPatientWithNonHumanSubject)
-->
    <rule context="//hl7:relatedSubject/hl7:code" id="d130e4779-false-d184322e0">
        <extends rule="CE"/>
...
-->
    <rule context="//hl7:relatedSubject/hl7:code/hl7:originalText" id="d184319e67-false-d184365e0">
        <extends rule="ED"/>
...
Item: (cdach_other_OriginalTextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:relatedSubject/hl7:code/hl7:originalText/hl7:reference[not(@nullFlavor)]" id="d184319e68-false-d184385e0">
        <extends rule="TEL"/>
...
Item: (chpalm_entry_HumanPatientWithNonHumanSubject)
-->
    <rule context="//hl7:relatedSubject/hl7:addr" id="d130e4802-false-d184399e0">
        <extends rule="AD"/>
