...
===========================================
ID: 2.16.756.5.30.1.1.10.9.46
Name: Header Template Compilation Medication List document
Description: Header Templates for Medication List document.
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron"
         id="template-2.16.756.5.30.1.1.10.9.46-2018-01-22T152929">
   <title>Header Template Compilation Medication List document</title>
   <!--
...
-->
   ...
   <rule context="//hl7:id[not(@nullFlavor)]" id="d272337e17-false-d272343e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:title[not(@nullFlavor)]" id="d19e16827-false-d272416e0">
      <extends rule="ST"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:setId" id="d272510e41-false-d272525e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:versionNumber" id="d272510e58-false-d272550e0">
...
-->
   ...
   <rule context="//hl7:informant" id="d272565e13-false-d272599e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:authorization" id="d273313e13-false-d273319e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:componentOf" id="d273411e26-false-d273476e0">
      <assert role="error"
...
-->
   <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:responsibleParty">
      <extends rule="d273793e0-false-d273809e0"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.113-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule id="d273793e0-false-d273809e0" abstract="true">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
              test="string(@classCode)=('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for @classCode SHALL be 'ASSIGNED'.</assert>
      <assert role="error"
