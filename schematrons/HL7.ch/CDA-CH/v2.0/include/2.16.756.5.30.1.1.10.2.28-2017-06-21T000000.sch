...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron"
         id="template-2.16.756.5.30.1.1.10.2.28-2017-06-21T000000">
...
-->
   ...
   <rule context="*[hl7:documentationOf[hl7:templateId[@root='2.16.756.5.30.1.1.10.2.28']]]/hl7:documentationOf[hl7:templateId[@root='2.16.756.5.30.1.1.10.2.28']]"
         id="d19e1357-false-d142183e0">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachlrep-html-20180507T170321/tmp-2.16.756.5.30.1.1.10.2.28-2017-06-21T000000.html"
...
-->
   ...
   <rule context="*[hl7:documentationOf[hl7:templateId[@root='2.16.756.5.30.1.1.10.2.28']]]/hl7:documentationOf[hl7:templateId[@root='2.16.756.5.30.1.1.10.2.28']]/hl7:templateId[@root='2.16.756.5.30.1.1.10.2.28']"
      ...
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachlrep-html-20180507T170321/tmp-2.16.756.5.30.1.1.10.2.28-2017-06-21T000000.html"
              test="string(@root)=('2.16.756.5.30.1.1.10.2.28')">(chpalm_header_DocumentationOfLaboratoryPerformer): The value for @root SHALL be '2.16.756.5.30.1.1.10.2.28'.</assert>
   </rule>
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.2.28
