...
<rule xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="TEL.AT">
    ...
    <report role="warning" test="not(not(@use) or translate(concat(' ', @use, ' '), '(H|HP|HV|WP|AS|EC|MC|PG) ', '') = '')" see="https://art-decor.org/mediawiki/index.php?title=DTr1_TEL.AT">dtr1-2-TEL.AT: @use MUSS aus den Werten 'H', 'HP', 'HV', 'WP', 'AS', 'EC', 'MC', 'PG' gewählt werden.</report>
