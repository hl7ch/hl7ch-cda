...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-2.16.756.5.30.1.1.10.9.33-2018-04-18T000000">
...
-->
    <rule context="//hl7:id" id="d130e6409-false-d207124e0">
        <extends rule="II"/>
...
Item: (cdach_other_OrganizationCompilationIdNameAddrTelecom)
-->
    <rule context="//hl7:name" id="d130e6418-false-d207145e0">
        <extends rule="ON"/>
...
Item: (cdach_other_OrganizationCompilationIdNameAddrTelecom)
-->
    <rule context="//hl7:telecom" id="d130e6421-false-d207155e0">
        <extends rule="TEL"/>
