...
-->
    <rule context="//hl7:functionCode[concat(@code, @codeSystem) = doc('include/voc-2.16.756.5.30.1.127.3.10.1.1.3-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code, @codeSystem) or @nullFlavor]" id="d130e5815-false-d201899e0">
        <extends rule="CE"/>
...
Item: (cdach_other_AuthorCompilationWithNameAddrTelecom)
-->
    <rule context="//hl7:functionCode[concat(@code, @codeSystem) = doc('include/voc-2.16.756.5.30.1.127.3.10.1.1.3-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code, @codeSystem) or @nullFlavor]/hl7:translation" id="d130e5846-false-d201950e0">
...
Item: (cdach_other_AuthorCompilationWithNameAddrTelecom)
-->
    <rule context="//hl7:time" id="d130e5853-false-d201984e0">
...
Item: (cdach_other_AuthorCompilationWithNameAddrTelecom)
-->
    <rule context="//hl7:assignedAuthor" id="d130e5856-false-d202038e0">
...
Item: (cdach_other_AuthorCompilationWithNameAddrTelecom)
-->
    <rule context="//hl7:assignedAuthor/hl7:id" id="d130e5859-false-d202148e0">
        <extends rule="II"/>
...
Item: (cdach_other_AuthorCompilationWithNameAddrTelecom)
-->
    <rule context="//hl7:assignedAuthor/hl7:telecom" id="d130e5871-false-d202351e0">
        <extends rule="TEL"/>
