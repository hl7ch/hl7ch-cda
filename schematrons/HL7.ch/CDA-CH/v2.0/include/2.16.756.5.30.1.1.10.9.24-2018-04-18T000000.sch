...
-->
    <rule context="//hl7:id" id="d130e6046-false-d203905e0">
        <extends rule="II"/>
...
Item: (cdach_other_OrganizationCompilationWithName)
-->
    <rule context="//hl7:name" id="d130e6055-false-d203926e0">
        <extends rule="ON"/>
...
Item: (cdach_other_OrganizationCompilationWithName)
-->
    <rule context="//hl7:telecom" id="d130e6058-false-d203936e0">
        <extends rule="TEL"/>
