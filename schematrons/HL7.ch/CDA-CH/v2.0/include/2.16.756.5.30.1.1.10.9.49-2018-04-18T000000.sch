...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-2.16.756.5.30.1.1.10.9.49-2018-04-18T000000">
...
-->
    <rule context="//hl7:originalText" id="d3165399e6972-false-d3220862e0">
        <extends rule="ED"/>
...
Item: (cdach_other_OriginalTextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:originalText/hl7:reference[not(@nullFlavor)]" id="d3165399e6973-false-d3220880e0">
        <extends rule="TEL"/>
