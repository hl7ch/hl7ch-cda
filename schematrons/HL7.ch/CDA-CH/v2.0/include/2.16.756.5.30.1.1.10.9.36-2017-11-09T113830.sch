...
-->
    <rule context="//hl7:id[not(@nullFlavor)]" id="d730178e9-false-d730183e0">
        <extends rule="II"/>
...
-->
    <rule context="//hl7:code[@codeSystem='2.16.840.1.113883.6.1']" id="d730184e39-false-d730209e0">
        <extends rule="CE"/>
...
Item: (cdach_header_DocumentCode)
-->
    <rule context="//hl7:code[@codeSystem='2.16.840.1.113883.6.1']/hl7:translation[@codeSystem='2.16.840.1.113883.6.96' or concat(@code,@codeSystem)=doc('include/voc-2.16.756.5.30.1.127.3.10.1.27-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem)]" id="d730184e50-false-d730260e0">
        <extends rule="CD"/>
...
-->
    <rule context="//hl7:title[not(@nullFlavor)]" id="d189909e5091-false-d730306e0">
        <extends rule="ST"/>
...
Item: (cdach_other_HeaderTemplateCompilation)
-->
    <rule context="//hl7:effectiveTime[not(@nullFlavor)]" id="d189909e5094-false-d730316e0">
...
-->
    <rule context="//hl7:confidentialityCode[@codeSystem='2.16.840.1.113883.6.96' or concat(@code,@codeSystem)=doc('include/voc-2.16.756.5.30.1.127.3.10.1.5-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem)]" id="d730317e36-false-d730333e0">
        <extends rule="CE"/>
...
-->
    <rule context="//hl7:languageCode[not(@nullFlavor)]" id="d730334e46-false-d730383e0">
        <extends rule="CS"/>
...
-->
    <rule context="//hl7:setId" id="d730384e28-false-d730397e0">
        <extends rule="II"/>
...
Item: (cdach_header_DocumentSetIdAndVersionNumber)
-->
    <rule context="//hl7:versionNumber" id="d730384e37-false-d730421e0">
...
Item: (CDAinformant)
-->
    <rule context="//hl7:informant" id="d730436e8-false-d730469e0">
...
-->
    <rule context="//hl7:authorization" id="d731163e8-false-d731168e0">
...
Item: (CDAauthorization)
-->
    <rule context="//hl7:authorization/hl7:consent[hl7:statusCode[@code='completed' or @nullFlavor]]" id="d731163e10-false-d731190e0">
...
Item: (CDAauthorization)
-->
    <rule context="//hl7:authorization/hl7:consent[hl7:statusCode[@code='completed' or @nullFlavor]]/hl7:id" id="d731163e13-false-d731227e0">
        <extends rule="II"/>
...
Item: (CDAauthorization)
-->
    <rule context="//hl7:authorization/hl7:consent[hl7:statusCode[@code='completed' or @nullFlavor]]/hl7:code[@codeSystem='2.16.840.1.113883.5.4' or @nullFlavor]" id="d731163e14-false-d731238e0">
        <extends rule="CE"/>
...
Item: (CDAauthorization)
-->
    <rule context="//hl7:authorization/hl7:consent[hl7:statusCode[@code='completed' or @nullFlavor]]/hl7:statusCode[@code='completed' or @nullFlavor]" id="d731163e16-false-d731255e0">
        <extends rule="CS"/>
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf" id="d731256e21-false-d731320e0">
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter" id="d731256e23-false-d731436e0">
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:id" id="d731256e26-false-d731547e0">
        <extends rule="II"/>
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:code[concat(@code,@codeSystem)=doc('include/voc-2.16.840.1.113883.1.11.13955-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem) or @nullFlavor]" id="d731256e27-false-d731560e0">
        <extends rule="CE"/>
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:effectiveTime" id="d731256e31-false-d731581e0">
        <extends rule="IVL_TS"/>
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:dischargeDispositionCode" id="d731256e32-false-d731591e0">
        <extends rule="CE"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.113" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='CE' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(CDAcomponentOf): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:CE", found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
...
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:responsibleParty">
        <extends rule="d731256e36-false-d731647e0"/>
...
Item: (CDAAssignedEntity)
-->
    <rule id="d731256e36-false-d731647e0" abstract="true">
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.153" test="string(@classCode)=('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for @classCode SHALL be 'ASSIGNED'.</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.153" test="count(hl7:id)&gt;=1">(CDAAssignedEntity): element hl7:id is required [min 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.153" test="count(hl7:code[@codeSystem='2.16.840.1.113883.5.111' or @nullFlavor])&lt;=1">(CDAAssignedEntity): element hl7:code[@codeSystem='2.16.840.1.113883.5.111' or @nullFlavor] appears too often [max 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.153" test="count(hl7:assignedPerson)&lt;=1">(CDAAssignedEntity): element hl7:assignedPerson appears too often [max 1x].</assert>
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:encounterParticipant" id="d731256e38-false-d732070e0">
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:encounterParticipant/hl7:time" id="d731256e43-false-d732129e0">
        <extends rule="IVL_TS"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.113" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='IVL_TS' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(CDAcomponentOf): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:IVL_TS", found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:location" id="d731256e47-false-d732599e0">
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:location/hl7:healthCareFacility" id="d731256e49-false-d732643e0">
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:location/hl7:healthCareFacility/hl7:id" id="d731256e51-false-d732693e0">
        <extends rule="II"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.113" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='II' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(CDAcomponentOf): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II", found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (CDAcomponentOf)
-->
    <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:location/hl7:healthCareFacility/hl7:code[concat(@code,@codeSystem)=doc('include/voc-2.16.840.1.113883.1.11.17660-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem) or @nullFlavor]" id="d731256e52-false-d732706e0">
        <extends rule="CE"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.840.1.113883.10.12.113" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='CE' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(CDAcomponentOf): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:CE", found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
        <let name="theCode" value="@code"/>
        <let name="theCodeSystem" value="@codeSystem"/>
