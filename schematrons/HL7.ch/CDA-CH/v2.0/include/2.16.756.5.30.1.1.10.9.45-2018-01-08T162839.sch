...
===========================================
ID: 2.16.756.5.30.1.1.10.9.45
Name: Header Template Compilation Medication Prescription document
Description: Header Templates for Medication Prescription
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron"
         id="template-2.16.756.5.30.1.1.10.9.45-2018-01-08T162839">
   <title>Header Template Compilation Medication Prescription document</title>
   <!--
...
-->
   ...
   <rule context="//hl7:id[not(@nullFlavor)]" id="d269294e17-false-d269300e0">
      <extends rule="II"/>
      <assert role="error"
...
Context: //hl7:code[(@code='57833-6' and @codeSystem='2.16.840.1.113883.6.1')]
Item: (DocumentCodeMedicationPrescription)
-->

   <rule context="//hl7:code[(@code='57833-6' and @codeSystem='2.16.840.1.113883.6.1')]"
         id="d269301e40-false-d269327e0">
      <extends rule="CE"/>
      <assert role="error"
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.2.52
Context: //hl7:code[(@code='57833-6' and @codeSystem='2.16.840.1.113883.6.1')]/hl7:translation[(@code='440545006' and @codeSystem='2.16.840.1.113883.6.96')]
Item: (DocumentCodeMedicationPrescription)
-->

   <rule context="//hl7:code[(@code='57833-6' and @codeSystem='2.16.840.1.113883.6.1')]/hl7:translation[(@code='440545006' and @codeSystem='2.16.840.1.113883.6.96')]"
         id="d269301e47-false-d269356e0">
      <extends rule="CD"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.2.52-2018-01-08T153402.html"
...
-->
   ...
   <rule context="//hl7:title[not(@nullFlavor)]" id="d19e16708-false-d269373e0">
      <extends rule="ST"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:setId" id="d269467e41-false-d269482e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:versionNumber" id="d269467e58-false-d269507e0">
...
-->
   ...
   <rule context="//hl7:informant" id="d269522e13-false-d269556e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:documentationOf" id="d19e16774-false-d270272e0">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.9.45-2018-01-08T162839.html"
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.9.45
Context: //hl7:documentationOf/hl7:serviceEvent
Item: (HeaderTemplateCompilationMedicationPrescriptionDocument)
-->

   <rule context="//hl7:documentationOf/hl7:serviceEvent"
         id="d19e16781-false-d270289e0">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.9.45-2018-01-08T162839.html"
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.9.45
Context: //hl7:documentationOf/hl7:serviceEvent/hl7:effectiveTime
Item: (HeaderTemplateCompilationMedicationPrescriptionDocument)
-->

   <rule context="//hl7:documentationOf/hl7:serviceEvent/hl7:effectiveTime"
         id="d19e16783-false-d270306e0">
      <extends rule="IVL_TS"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.9.45-2018-01-08T162839.html"
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.9.45
Context: //hl7:documentationOf/hl7:serviceEvent/hl7:effectiveTime/hl7:low
Item: (HeaderTemplateCompilationMedicationPrescriptionDocument)
-->

   <rule context="//hl7:documentationOf/hl7:serviceEvent/hl7:effectiveTime/hl7:low"
         id="d19e16788-false-d270337e0">
      <extends rule="TS"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.9.45-2018-01-08T162839.html"
              test="(local-name-from-QName(resolve-QName(@xsi:type,.))='TS' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HeaderTemplateCompilationMedicationPrescriptionDocument): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:TS", found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.9.45
Context: //hl7:documentationOf/hl7:serviceEvent/hl7:effectiveTime/hl7:high
Item: (HeaderTemplateCompilationMedicationPrescriptionDocument)
-->

   <rule context="//hl7:documentationOf/hl7:serviceEvent/hl7:effectiveTime/hl7:high"
         id="d19e16794-false-d270351e0">
      <extends rule="TS"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.9.45-2018-01-08T162839.html"
              test="(local-name-from-QName(resolve-QName(@xsi:type,.))='TS' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HeaderTemplateCompilationMedicationPrescriptionDocument): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:TS", found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
-->
   ...
   <rule context="//hl7:authorization" id="d270362e13-false-d270368e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:componentOf" id="d270460e26-false-d270525e0">
      <assert role="error"
...
-->
   <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:responsibleParty">
      <extends rule="d270842e0-false-d270858e0"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.113-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule id="d270842e0-false-d270858e0" abstract="true">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
              test="string(@classCode)=('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for @classCode SHALL be 'ASSIGNED'.</assert>
      <assert role="error"
