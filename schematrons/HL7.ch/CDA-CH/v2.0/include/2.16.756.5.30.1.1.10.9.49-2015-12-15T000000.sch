...
-->
    <rule context="//hl7:originalText" id="d523664e10658-false-d721470e0">
        <extends rule="ED"/>
...
Item: (cdach_other_OriginalTextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:originalText/hl7:reference[not(@nullFlavor)]" id="d523664e10659-false-d721490e0">
        <extends rule="TEL"/>
