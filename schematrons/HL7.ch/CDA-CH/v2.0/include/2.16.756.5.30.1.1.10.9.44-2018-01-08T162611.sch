...
===========================================
ID: 2.16.756.5.30.1.1.10.9.44
Name: Header Template Compilation MedicationTreatmentPlan
Description: Header Templates for MedicationTreatmentPlan
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron"
         id="template-2.16.756.5.30.1.1.10.9.44-2018-01-08T162611">
   <title>Header Template Compilation MedicationTreatmentPlan</title>
   <!--
...
-->
   ...
   <rule context="//hl7:id[not(@nullFlavor)]" id="d266343e17-false-d266349e0">
      <extends rule="II"/>
      <assert role="error"
...
Context: //hl7:code[(@code='77603-9' and @codeSystem='2.16.840.1.113883.6.1')]
Item: (DocumentCodeMedicationTreatmentPlan)
-->

   <rule context="//hl7:code[(@code='77603-9' and @codeSystem='2.16.840.1.113883.6.1')]"
         id="d266350e40-false-d266376e0">
      <extends rule="CE"/>
      <assert role="error"
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.2.54
Context: //hl7:code[(@code='77603-9' and @codeSystem='2.16.840.1.113883.6.1')]/hl7:translation[(@code='761931002' and @codeSystem='2.16.840.1.113883.6.96')]
Item: (DocumentCodeMedicationTreatmentPlan)
-->

   <rule context="//hl7:code[(@code='77603-9' and @codeSystem='2.16.840.1.113883.6.1')]/hl7:translation[(@code='761931002' and @codeSystem='2.16.840.1.113883.6.96')]"
         id="d266350e47-false-d266405e0">
      <extends rule="CD"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.2.54-2018-01-08T154525.html"
...
-->
   ...
   <rule context="//hl7:title[not(@nullFlavor)]" id="d19e16618-false-d266422e0">
      <extends rule="ST"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:setId" id="d266516e41-false-d266531e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:versionNumber" id="d266516e58-false-d266556e0">
...
-->
   ...
   <rule context="//hl7:informant" id="d266571e13-false-d266605e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:authorization" id="d267319e13-false-d267325e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:componentOf" id="d267417e26-false-d267482e0">
      <assert role="error"
...
-->
   <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:responsibleParty">
      <extends rule="d267799e0-false-d267815e0"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.113-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule id="d267799e0-false-d267815e0" abstract="true">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
              test="string(@classCode)=('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for @classCode SHALL be 'ASSIGNED'.</assert>
      <assert role="error"
