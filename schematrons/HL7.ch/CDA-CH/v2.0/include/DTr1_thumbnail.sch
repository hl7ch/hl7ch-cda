...
<rule xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="thumbnail">
    ...
    <assert role="error" test="not(@nullFlavor) or (@nullFlavor and not(@mediaType))" see="https://art-decor.org/mediawiki/index.php?title=DTr1_thumbnail">dtr1-10-thumbnail: no mediaType if null</assert>
    <assert role="error" test="not(@nullFlavor) or (@nullFlavor and not(@charset))" see="https://art-decor.org/mediawiki/index.php?title=DTr1_thumbnail">dtr1-11-thumbnail: no charset if null</assert>
    <assert role="error" test="not(@nullFlavor) or (@nullFlavor and not(@language))" see="https://art-decor.org/mediawiki/index.php?title=DTr1_thumbnail">dtr1-12-thumbnail: no language if null</assert>
    <assert role="error" test="not(@nullFlavor) or (@nullFlavor and not(@compression))" see="https://art-decor.org/mediawiki/index.php?title=DTr1_thumbnail">dtr1-13-thumbnail: no compression if null</assert>
    <assert role="error" test="not(@nullFlavor) or (@nullFlavor and not(@integrityCheck))" see="https://art-decor.org/mediawiki/index.php?title=DTr1_thumbnail">dtr1-14-thumbnail: no integrityCheck if null</assert>
    <assert role="error" test="not(@nullFlavor) or (@nullFlavor and not(@integrityCheckAlgorithm))" see="https://art-decor.org/mediawiki/index.php?title=DTr1_thumbnail">dtr1-15-thumbnail: no integrityCheckAlgorithm if null</assert>
</rule>