...
-->
    <rule context="//hl7:id" id="d130e9471-false-d185185e0">
        <extends rule="II"/>
...
Item: (cdach_other_OrganizationCompilationWithName)
-->
    <rule context="//hl7:name" id="d130e9480-false-d185209e0">
        <extends rule="ON"/>
...
Item: (cdach_other_OrganizationCompilationWithName)
-->
    <rule context="//hl7:telecom" id="d130e9483-false-d185219e0">
        <extends rule="TEL"/>
