...
-->
    <rule context="//hl7:id" id="d523664e5036-false-d1060428e0">
        <extends rule="II"/>
...
Item: (cdach_other_OrganizationCompilationWithName)
-->
    <rule context="//hl7:name" id="d523664e5045-false-d1060449e0">
        <extends rule="ON"/>
...
Item: (cdach_other_OrganizationCompilationWithName)
-->
    <rule context="//hl7:telecom" id="d523664e5048-false-d1060459e0">
        <extends rule="TEL"/>
