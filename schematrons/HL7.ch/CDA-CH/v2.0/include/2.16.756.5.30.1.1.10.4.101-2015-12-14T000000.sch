...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-2.16.756.5.30.1.1.10.4.101-2015-12-14T000000">
...
-->
    <rule context="*[hl7:templateId[@root='2.16.756.5.30.1.1.10.4.101']]" id="d130e4506-false-d468548e0">
        ...
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.4.101" test="count(hl7:time)&lt;=1">(chpcc_entry_ImmunizationPerformer): element hl7:time appears too often [max 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.4.101" test="count(hl7:assignedEntity[hl7:id[@root='2.51.1.3']])&gt;=1">(chpcc_entry_ImmunizationPerformer): element hl7:assignedEntity[hl7:id[@root='2.51.1.3']] is required [min 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.4.101" test="count(hl7:assignedEntity[hl7:id[@root='2.51.1.3']])&lt;=1">(chpcc_entry_ImmunizationPerformer): element hl7:assignedEntity[hl7:id[@root='2.51.1.3']] appears too often [max 1x].</assert>
    </rule>
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.4.101
...
-->
    <rule context="*[hl7:templateId[@root='2.16.756.5.30.1.1.10.4.101']]/hl7:assignedEntity[hl7:id[@root='2.51.1.3']]">
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.9.51" test="count(hl7:id[@root='2.51.1.3'])&gt;=1">(cdach_other_AssignedEntityCompilationGlnName): element hl7:id[@root='2.51.1.3'] is required [min 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.9.51" test="count(hl7:id[@root='2.51.1.3'])&lt;=1">(cdach_other_AssignedEntityCompilationGlnName): element hl7:id[@root='2.51.1.3'] appears too often [max 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.9.51" test="count(hl7:code[@codeSystem='2.16.840.1.113883.6.96' or concat(@code,@codeSystem)=doc('include/voc-2.16.756.5.30.1.127.3.10.1.1.3-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem)])&lt;=1">(cdach_other_AssignedEntityCompilationGlnName): element hl7:code[@codeSystem='2.16.840.1.113883.6.96' or concat(@code,@codeSystem)=doc('include/voc-2.16.756.5.30.1.127.3.10.1.1.3-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem)] appears too often [max 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.9.51" test="count(hl7:assignedPerson)&lt;=1">(cdach_other_AssignedEntityCompilationGlnName): element hl7:assignedPerson appears too often [max 1x].</assert>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--cdachvacd-?id=2.16.756.5.30.1.1.10.9.51" test="count(hl7:representedOrganization[hl7:id[@root='2.51.1.3']])&lt;=1">(cdach_other_AssignedEntityCompilationGlnName): element hl7:representedOrganization[hl7:id[@root='2.51.1.3']] appears too often [max 1x].</assert>
    </rule>
