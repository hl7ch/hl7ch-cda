...
<rule xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="CS">
    ...
    <assert role="error" test="not(@codeSystem)" see="https://art-decor.org/mediawiki/index.php?title=DTr1_CS">dtr1-2-CS: cannot have codeSystem</assert>
    <assert role="error" test="not(@codeSystemName)" see="https://art-decor.org/mediawiki/index.php?title=DTr1_CS">dtr1-3-CS: cannot have codeSystemName</assert>
