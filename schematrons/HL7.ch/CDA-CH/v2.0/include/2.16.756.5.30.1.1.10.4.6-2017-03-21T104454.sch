...
-->
    <rule context="//hl7:templateId[@root='1.3.6.1.4.1.19376.1.3.3.1.3.1']" id="d523664e7587-false-d697687e0">
        <extends rule="II"/>
...
Item: (chpalm_entry_HumanPatientWithNonHumanSubject)
-->
    <rule context="//hl7:relatedSubject" id="d523664e7592-false-d697704e0">
...
Item: (chpalm_entry_HumanPatientWithNonHumanSubject)
-->
    <rule context="//hl7:relatedSubject/hl7:code" id="d523664e7594-false-d697734e0">
        <extends rule="CE"/>
...
-->
    <rule context="//hl7:relatedSubject/hl7:code/hl7:originalText" id="d697731e57-false-d697777e0">
        <extends rule="ED"/>
...
Item: (cdach_other_OriginalTextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:relatedSubject/hl7:code/hl7:originalText/hl7:reference[not(@nullFlavor)]" id="d697731e58-false-d697797e0">
        <extends rule="TEL"/>
...
Item: (chpalm_entry_HumanPatientWithNonHumanSubject)
-->
    <rule context="//hl7:relatedSubject/hl7:addr" id="d523664e7640-false-d697811e0">
        <extends rule="AD"/>
