...
-->
    <rule context="//hl7:code[(@code='11369-6' and @codeSystem='2.16.840.1.113883.6.1')]" id="d130e2011-false-d456787e0">
        <extends rule="CE"/>
...
Item: (cdachvacd_header_DocumentCode)
-->
    <rule context="//hl7:code[(@code='11369-6' and @codeSystem='2.16.840.1.113883.6.1')]/hl7:translation[(@code='41000179103' and @codeSystem='2.16.840.1.113883.6.96') or concat(@code,@codeSystem)=doc('include/voc-2.16.756.5.30.1.127.3.10.1.27-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem)]" id="d130e2021-false-d456835e0">
        <extends rule="CD"/>
