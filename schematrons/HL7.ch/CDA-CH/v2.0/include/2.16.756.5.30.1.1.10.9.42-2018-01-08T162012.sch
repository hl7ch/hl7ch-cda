...
-->
   ...
   <rule context="//hl7:id[not(@nullFlavor)]" id="d260441e17-false-d260447e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:title[not(@nullFlavor)]" id="d19e16432-false-d260520e0">
      <extends rule="ST"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:setId" id="d260614e41-false-d260629e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:versionNumber" id="d260614e58-false-d260654e0">
...
-->
   ...
   <rule context="//hl7:informant" id="d260669e13-false-d260703e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:authorization" id="d261417e13-false-d261423e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:componentOf" id="d261515e26-false-d261580e0">
      <assert role="error"
...
-->
   <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:responsibleParty">
      <extends rule="d261897e0-false-d261913e0"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.113-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule id="d261897e0-false-d261913e0" abstract="true">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
              test="string(@classCode)=('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for @classCode SHALL be 'ASSIGNED'.</assert>
      <assert role="error"
