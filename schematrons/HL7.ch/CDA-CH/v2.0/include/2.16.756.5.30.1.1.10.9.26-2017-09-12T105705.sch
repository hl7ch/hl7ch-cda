...
-->
    <rule context="//hl7:id[@root='2.51.1.3']" id="d523664e5100-false-d1060660e0">
        <extends rule="II"/>
...
Item: (cdach_other_OrganizationCompilationGlnNameAddrTelecom)
-->
    <rule context="//hl7:id" id="d523664e5107-false-d1060681e0">
        <extends rule="II"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--hl7chcda-?id=2.16.756.5.30.1.1.10.9.26" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='II' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(cdach_other_OrganizationCompilationGlnNameAddrTelecom): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II", found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (cdach_other_OrganizationCompilationGlnNameAddrTelecom)
-->
    <rule context="//hl7:name" id="d523664e5116-false-d1060702e0">
        <extends rule="ON"/>
...
Item: (cdach_other_OrganizationCompilationGlnNameAddrTelecom)
-->
    <rule context="//hl7:telecom" id="d523664e5119-false-d1060712e0">
        <extends rule="TEL"/>
