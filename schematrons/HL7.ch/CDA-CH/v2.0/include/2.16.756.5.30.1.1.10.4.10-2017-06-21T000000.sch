...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-2.16.756.5.30.1.1.10.4.10-2017-06-21T000000">
...
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]" id="d130e2578-false-d149609e0">
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.4.10
Context: //hl7:participantRole[hl7:playingDevice]/hl7:playingDevice
Item: (chpalm_entry_ParticipantBodyDevice)
-->
...
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]/hl7:playingDevice">
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.9.21
Context: //hl7:participantRole[hl7:playingDevice]/hl7:playingDevice/hl7:manufacturerModelName
Item: (cdach_other_DeviceCompilationWithName)
-->

<!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.9.21
Context: //hl7:participantRole[hl7:playingDevice]/hl7:playingDevice/hl7:softwareName
Item: (cdach_other_DeviceCompilationWithName)
-->
<!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.4.10
Context: //hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity
Item: (chpalm_entry_ParticipantBodyDevice)
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity" id="d130e2582-false-d149697e0">
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.4.10
Context: //hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:id
Item: (chpalm_entry_ParticipantBodyDevice)
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:id" id="d130e2585-false-d149722e0">
        <extends rule="II"/>
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.4.10
Context: //hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:code
Item: (chpalm_entry_ParticipantBodyDevice)
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:code" id="d130e2594-false-d149746e0">
        <extends rule="CE"/>
...
Context: //hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:code/hl7:originalText
Item: (cdach_other_OriginalTextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:code/hl7:originalText" id="d149743e67-false-d149789e0">
        <extends rule="ED"/>
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.9.49
Context: //hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:code/hl7:originalText/hl7:reference[not(@nullFlavor)]
Item: (cdach_other_OriginalTextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:code/hl7:originalText/hl7:reference[not(@nullFlavor)]" id="d149743e68-false-d149809e0">
        <extends rule="TEL"/>
   ...
   <!--
Template derived rules for ID: 2.16.756.5.30.1.1.10.4.10
Context: //hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:desc
Item: (chpalm_entry_ParticipantBodyDevice)
-->
    <rule context="//hl7:participantRole[hl7:playingDevice]/hl7:scopingEntity/hl7:desc" id="d130e2619-false-d149823e0">
        <extends rule="ED"/>
