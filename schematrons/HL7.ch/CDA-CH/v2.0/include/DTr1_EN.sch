...
<rule xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="EN">
    ...
    <report role="warning" test="*[not(@nullFlavor)][normalize-space(.)='']" see="https://art-decor.org/mediawiki/index.php?title=DTr1_EN">dtr1-3-EN: empty name particles should not be present.</report>
