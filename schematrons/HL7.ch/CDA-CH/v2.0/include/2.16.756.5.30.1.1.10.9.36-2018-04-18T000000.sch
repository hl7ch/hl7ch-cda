...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron"
         id="template-2.16.756.5.30.1.1.10.9.36-2018-04-18T000000">
...
-->
   ...
   <rule context="//hl7:id[not(@nullFlavor)]" id="d254493e17-false-d254499e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:code[@codeSystem='2.16.840.1.113883.6.1']"
         id="d254500e55-false-d254526e0">
      <extends rule="CE"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:code[@codeSystem='2.16.840.1.113883.6.1']/hl7:translation[@codeSystem='2.16.840.1.113883.6.96' or concat(@code,@codeSystem)=doc('include/voc-2.16.756.5.30.1.127.3.10.1.27-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code,@codeSystem)]"
         id="d254500e77-false-d254578e0">
      <extends rule="CD"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.756.5.30.1.1.10.2.44-2018-04-18T000000.html"
...
-->
   ...
   <rule context="//hl7:title[not(@nullFlavor)]" id="d19e16267-false-d254625e0">
      <extends rule="ST"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:setId" id="d254706e41-false-d254721e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:versionNumber" id="d254706e58-false-d254746e0">
...
-->
   ...
   <rule context="//hl7:informant" id="d254761e13-false-d254795e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:authorization" id="d255515e13-false-d255521e0">
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:componentOf" id="d255613e26-false-d255678e0">
      <assert role="error"
...
-->
   <rule context="//hl7:componentOf/hl7:encompassingEncounter/hl7:responsibleParty">
      <extends rule="d255995e0-false-d256011e0"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.113-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule id="d255995e0-false-d256011e0" abstract="true">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20180508T090351/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
              test="string(@classCode)=('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for @classCode SHALL be 'ASSIGNED'.</assert>
      <assert role="error"
