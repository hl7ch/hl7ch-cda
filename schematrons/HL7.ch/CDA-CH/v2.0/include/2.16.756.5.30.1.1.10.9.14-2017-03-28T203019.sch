...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-2.16.756.5.30.1.1.10.9.14-2017-03-28T203019">
...
-->
    <rule context="//hl7:text[not(@nullFlavor)]" id="d523664e4202-false-d1057004e0">
        <extends rule="ED"/>
...
Item: (cdach_other_TextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:text[not(@nullFlavor)]/hl7:reference[not(@nullFlavor)]" id="d523664e4203-false-d1057024e0">
        <extends rule="TEL"/>
