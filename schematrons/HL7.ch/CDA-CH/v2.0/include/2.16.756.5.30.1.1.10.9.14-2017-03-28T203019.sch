...
-->
    <rule context="//hl7:text[not(@nullFlavor)]" id="d130e9156-false-d183125e0">
        <extends rule="ED"/>
...
Item: (cdach_other_TextElementWithReferenceToNarrativeText)
-->
    <rule context="//hl7:text[not(@nullFlavor)]/hl7:reference[not(@nullFlavor)]" id="d130e9157-false-d183145e0">
        <extends rule="TEL"/>
