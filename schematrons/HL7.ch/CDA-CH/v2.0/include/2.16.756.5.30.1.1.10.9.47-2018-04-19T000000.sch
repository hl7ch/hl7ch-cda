...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="template-2.16.756.5.30.1.1.10.9.47-2018-04-19T000000">
...
-->
    <rule context="//hl7:id" id="d130e6711-false-d207739e0">
        <extends rule="II"/>
...
Item: (cdachlrep_header_AssignedEntityForLaboratory)
-->
    <rule context="//hl7:telecom" id="d130e6728-false-d207943e0">
        <extends rule="TEL"/>
