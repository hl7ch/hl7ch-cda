...
History:
20.03.2011: Tony Schaller, medshare GmbH (Initial draft)
...
<schema xmlns='http://purl.oclc.org/dsdl/schematron' xmlns:xhtml="http://www.w3.org/1999/xhtml">
	<xhtml:h1 class="title" lang="en">Master for ALIS-Connect case statistics: GrpStatus (casestat) V1.0</xhtml:h1>
	<xhtml:h1 class="title" lang="de_ch">Master-Schematron Regeln ALIS-Connect Fallstatistik: GrpStatus (casestat) V1.0</xhtml:h1>
