...
Master for GrpStatus document

History:
2011.03.20: Tony Schaller, medshare GmbH (Initial draft)
...
<!ENTITY ent-alisconnect-casestat-grpstatus SYSTEM 'alisconnect-casestat-grpstatus.ent'>
...
<schema xmlns='http://purl.oclc.org/dsdl/schematron' xmlns:xhtml="http://www.w3.org/1999/xhtml">
	<xhtml:h1 class="title" lang="en">Master for ALIS-Connect case statistics: GrpStatus (casestat) V1.1</xhtml:h1>
	<xhtml:h1 class="title" lang="de_ch">Master-Schematron Regeln ALIS-Connect Fallstatistik: GrpStatus (casestat) V1.1</xhtml:h1>
  ...
  <let name="swissdrg-valueset" value="document('medicationlist-voc2013.xml')/systems/system" />
	...
	<!-- reusable templates -->
	&ent-alisconnect-casestat-grpstatus;
