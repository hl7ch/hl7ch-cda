...
-->
   ...
   <rule context="//hl7:title[not(@nullFlavor)]" id="d41e19114-false-d269639e0">
      <extends rule="ST"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20200729T164922/tmp-2.16.756.5.30.1.1.10.9.42-2018-01-08T162012.html"
...
-->
   ...
   <rule context="//hl7:setId[not(@extension)]" id="d269721e39-false-d269735e0">
      <extends rule="II"/>
      <assert role="error"
...
-->
   ...
   <rule context="//hl7:versionNumber" id="d269721e56-false-d269756e0">
...
-->
   ...
   <rule context="//hl7:informant" id="d269770e13-false-d269804e0">
      <assert role="error"
...
-->
   <rule context="//hl7:componentOf[hl7:encompassingEncounter]/hl7:encompassingEncounter/hl7:responsibleParty">
      <extends rule="d270983e0-false-d270999e0"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20200729T164922/tmp-2.16.840.1.113883.10.12.113-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule id="d270983e0-false-d270999e0" abstract="true">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20200729T164922/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
              test="string(@classCode) = ('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for classCode SHALL be 'ASSIGNED'. Found: "<value-of select="@classCode"/>"</assert>
      <assert role="error"
