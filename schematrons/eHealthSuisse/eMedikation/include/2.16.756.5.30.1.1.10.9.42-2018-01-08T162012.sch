...
-->
   ...
   <rule fpi="RULC-1"
         context="//hl7:title[not(@nullFlavor)]"
         id="d42e19136-false-d287963e0">
      <extends rule="ST"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20210623T090058/tmp-2.16.756.5.30.1.1.10.9.42-2018-01-08T162012.html"
...
-->
   <rule fpi="RULC-1" context="//hl7:informant/hl7:assignedEntity">
      <assert role="error"
...
Item: (CDAAssignedEntity)
-->
   <rule fpi="RULC-1" context="//hl7:informant/hl7:assignedEntity/hl7:id">
      <extends rule="II"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20210623T090058/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule fpi="RULC-1" context="//hl7:informant/hl7:assignedEntity/hl7:code">
      <extends rule="CE"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20210623T090058/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule fpi="RULC-1" context="//hl7:informant/hl7:assignedEntity/hl7:addr">
      <extends rule="AD"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20210623T090058/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule fpi="RULC-1" context="//hl7:informant/hl7:assignedEntity/hl7:telecom">
      <extends rule="TEL"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20210623T090058/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
...
-->
   <rule fpi="RULC-1" context="//hl7:informant/hl7:relatedEntity[@classCode]">
      <assert role="error"
...
-->
   <rule fpi="RULC-1"
         context="//hl7:componentOf[hl7:encompassingEncounter]/hl7:encompassingEncounter/hl7:responsibleParty">
      <extends rule="d289307e0-false-d289323e0"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20210623T090058/tmp-2.16.840.1.113883.10.12.113-2005-09-07T000000.html"
...
Item: (CDAAssignedEntity)
-->
   <rule fpi="RULC-1" id="d289307e0-false-d289323e0" abstract="true">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachemed-html-20210623T090058/tmp-2.16.840.1.113883.10.12.153-2005-09-07T000000.html"
              test="string(@classCode) = ('ASSIGNED') or not(@classCode)">(CDAAssignedEntity): The value for classCode SHALL be 'ASSIGNED'. Found: "<value-of select="@classCode"/>"</assert>
      <assert role="error"
