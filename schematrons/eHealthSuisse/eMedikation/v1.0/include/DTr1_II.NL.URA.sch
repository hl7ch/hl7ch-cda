...
<rule xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="II.NL.URA">
    ...
    <assert role="error" test="not(@root='2.16.528.1.1007.3.3') or matches(@extension,'^[0-9]{8}$')">dtr1-2-II.NL.URA: UZI-registerabonneenummer MOET 8 cijfers lang zijn</assert>
</rule>