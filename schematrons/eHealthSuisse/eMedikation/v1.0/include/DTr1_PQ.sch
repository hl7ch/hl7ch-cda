...
<rule xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="PQ">
    <extends rule="QTY"/>
    <assert role="error" test="(@nullFlavor or @value or *) and not(@nullFlavor and @value)">dtr1-1-PQ: null or value or child element in case of extension</assert>
    <!--
    ...
    <assert test="count($translations)=count(distinct-values($translations))">dtr1-3-PQ: [RIM-002] translations SHALL be distinct</assert>
</rule>