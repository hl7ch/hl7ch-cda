...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction CDA-CH-VACD - Immunization Recommendation Response 2018 (2.16.756.5.30.1.127.77.1.4.6 2018-04-10T18:09:59)</title>
   ...
   <!-- CDA-CH-VACD-RSP-V21 -->
   <pattern>
      <title>CDA-CH-VACD-RSP-V21</title>
      <rule context="/">
         <assert role="warning"
   ...
   <include href="include/2.16.756.5.30.1.1.10.1.18-2020-06-26T000000-closed.sch"/>


   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.18-2020-06-26T000000"/>
   ...
   <phase id="CDA-CH-VACD-RSP-V21">
      <active pattern="template-2.16.756.5.30.1.1.10.1.18-2020-06-26T000000"/>
   </phase>
   <phase id="CDA-CH-VACD-RSP-V21-closed">
      <active pattern="template-2.16.756.5.30.1.1.10.1.18-2020-06-26T000000-closed"/>
   </phase>
   ...
   <include href="include/2.16.756.5.30.1.1.10.3.48-2016-11-12T000000.sch"/>
   ...
   <include href="include/2.16.756.5.30.1.1.10.4.93-2016-11-12T000000.sch"/>
