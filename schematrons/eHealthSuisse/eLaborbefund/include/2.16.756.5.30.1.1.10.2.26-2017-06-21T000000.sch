...
-->
   ...
   <rule context="*[hl7:recordTarget[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.2'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.2.26']]]"
         id="d41e1767-false-d276208e0">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachlrep-html-20200813T090700/tmp-2.16.756.5.30.1.1.10.2.26-2017-06-21T000000.html"
...
-->
   ...
   <rule context="*[hl7:recordTarget[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.2'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.2.26']]]/hl7:recordTarget[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.2'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.2.26']]/hl7:patientRole[hl7:patient[@nullFlavor = 'OTH']]"
         id="d41e1854-false-d276289e0">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachlrep-html-20200813T090700/tmp-2.16.756.5.30.1.1.10.2.26-2017-06-21T000000.html"
...
-->
   ...
   <rule context="*[hl7:recordTarget[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.2'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.2.26']]]/hl7:recordTarget[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.2'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.2.26']]/hl7:patientRole[hl7:patient[@nullFlavor = 'OTH']]/hl7:id"
         id="d41e1856-false-d276311e0">
      <extends rule="II"/>
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachlrep-html-20200813T090700/tmp-2.16.756.5.30.1.1.10.2.26-2017-06-21T000000.html"
              test="(local-name-from-QName(resolve-QName(@xsi:type,.))='II' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(chpalm_header_RecordTargetNonHumanSubject): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
-->
   ...
   <rule context="*[hl7:recordTarget[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.2'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.2.26']]]/hl7:recordTarget[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.3.3.1.2'] and hl7:templateId[@root = '2.16.756.5.30.1.1.10.2.26']]/hl7:patientRole[hl7:patient[@nullFlavor = 'OTH']]/hl7:patient[@nullFlavor = 'OTH']"
         id="d41e1871-false-d276330e0">
      <assert role="error"
              see="http://ehealthsuisse.art-decor.org/cdachlrep-html-20200813T090700/tmp-2.16.756.5.30.1.1.10.2.26-2017-06-21T000000.html"
